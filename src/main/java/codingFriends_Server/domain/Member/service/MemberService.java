...
public class MemberService implements UserDetailsService {
	...
	public MemberInfoResponseDto updateMemberLevel(String snsId,
		MemberlevelUpdateRequestDto memberlevelUpdateRequestDto) {
		Member member = memberRepository.findBySnsId(snsId)
			.orElseThrow(() -> new CustomException(HttpStatus.NOT_FOUND, "member를 찾을 수 없습니다."));
	...
	public MemberInfoResponseDto updateMemberLanguage(String snsId,
		MemberFavLanguageRequestDto memberUpdateRequestDto) {
		Member member = memberRepository.findBySnsId(snsId)
			.orElseThrow(() -> new CustomException(HttpStatus.NOT_FOUND, "member를 찾을 수 없습니다."));
	...
	public void deleteMember(Long id) {
		Member member = memberRepository.findMemberById(id)
			.orElseThrow(() -> new CustomException(HttpStatus.BAD_REQUEST, "member를 찾을 수 없습니다."));
